...
-- * Docker Rules
-- see <https://hackage.haskell.org/package/shake-0.17.3/docs/Development-Shake-Rule.html#t:BuiltinIdentity Shake API> documentation for details
...
data ContainerInspect = ContainerInspect { containerId    :: ContainerId
